    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-sm-6 text-right">
          <button type="button" class="btn btn-outline-primary">HMI TIMBANGAN </button>
        </div>
      </div>
      <div class="col-sm-6 offset-sm-3">
        ...
        <div class="form-signin">
          ...
          <div v-if="$store.state.Login.userid !== 0">
            ...
            <router-link :class="['btn-machine', 'btn', 'btn-outline-primary', 'btn-sm']" to="/timbanganpage">Tekan untuk melanjutkan</router-link>
          </div>
        </div>
      </div>
      <div class="row">
